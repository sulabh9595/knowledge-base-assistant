"""
Automated Video Demo: Full Application Overview, Kokoro Neural TTS, and .skills/tts-evaluation.md Metrics Taxonomy.
"""
...
def record_full_demo():
    ...
    with sync_playwright() as p:
        ...
        # --- 3. QUALITY & EVALUATION DASHBOARD ---
        print("[6/7] Navigating to DeepEval & Quality Dashboard (TTS Evaluation Metrics)...")
        ...
        # Highlight Core TTS Evaluation Metrics Taxonomy (.skills/tts-evaluation.md)
        print("Displaying Core TTS Evaluation Metrics Taxonomy...")
        page.mouse.wheel(0, 200)
        time.sleep(4.5)  # Generous pause for viewer to read all 6 evaluation categories
        
        # Scroll down to Provider Benchmark Comparison
        print("Displaying Provider Benchmark Comparison...")
        page.mouse.wheel(0, 300)
        time.sleep(3.5)
        
        # Scroll down to Sample-Level Evaluated Metrics Details
        print("Displaying Sample-Level Tested Metrics (WER, CER, SNR, RTF, F0 Pitch, WPM)...")
        ...
        # Scroll down to show passing Kokoro and TTS test cases (26/26 passed)
        page.mouse.wheel(0, 300)
        time.sleep(3.5)
        page.mouse.wheel(0, -300)
        time.sleep(1.5)
        ...
        final_video = os.path.join(video_dir, "kokoro_tts_overview_demo.webm")
